...
export default function Calender() {
  ...
  const fetchData = async () => {
    try {
      ...
      // 2) holiday API - using absolute URL you gave
      // If your axiosInstance baseURL already points to http://192.168.0.143:8000
      // you can use: await axiosInstance.get('/api/method/cowberry_app.api.holiday.get_holiday_list')
      const holidayRes = await axiosInstance.get(
        "http://192.168.0.143:8000/api/method/cowberry_app.api.holiday.get_holiday_list"
      );
...
// top toggle filter add karne se pahle ka code (Leave, Attendance, Holiday)
