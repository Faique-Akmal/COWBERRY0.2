    ...
    const fetchUserDetails = async () => {
      try {
        ...
        setUserData({
          ...
          role: employeeRole,
          profile_image: profile.profile_image, // ensure image field passed through
        });
      } catch (error) {
          ...
          <View style={styles.profileContainer}>
            ...
            {userData ? (
              userData.profile_image ? (
                ...
                <View style={[styles.avatar, styles.initialCircle]}>
...
// image ko hatake name ka first letter dikhane se pahle ka code
...
// customDrawer with chat functionality 
