...
const styles = StyleSheet.create({
  ...
  left:{ marginRight:10 },
  avatar:{ width:48, height:48, borderRadius:24, backgroundColor:'#8e44ad', justifyContent:'center', alignItems:'center' },
  center:{ flex:1 },
  name:{ fontWeight:'600', fontSize:16 },
  last:{ color:'#666', marginTop:4 },
  right:{ alignItems:'flex-end' },
  time:{ color:'#999', fontSize:12 },
  unread:{ marginTop:8, backgroundColor:'#ff3b30', minWidth:22, paddingHorizontal:6, height:22, borderRadius:11, justifyContent:'center', alignItems:'center' },
