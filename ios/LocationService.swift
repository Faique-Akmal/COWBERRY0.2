...
class LocationService: NSObject, CLLocationManagerDelegate {
  ...
  private func postLocation(lat: Double, lng: Double, speed: Double) {
    ...
    var payload: [String: Any] = [
      ...
      "pause": false,
      // timestamp fields: keep "timestamp" as local formatted (dd-MM-yyyy HH:mm:ss)
    ...
    queueAccess.async {
      ...
      func sendOne(_ idx: Int) {
        ...
        var payload: [String: Any] = [
          ...
          "speed": it.speed,
          "pause": it.pause,
          // send both forms: keep "timestamp" as local formatted (dd-MM-yyyy HH:mm:ss)
          "timestamp": timestampLocal,
          "timestamp_utc": timestampUtc,
          "tz_offset_minutes": tzOffsetMinutes
        ]
  ...
  private func localDateTimeString(from timeInterval: TimeInterval) -> String {
    ...
    df.dateFormat = "dd-MM-yyyy HH:mm:ss"   // backend expects dd-mm-yyyy (date part) — kept here
    return df.string(from: date) // e.g. "06-10-2025 14:42:00"
  }
}
